...
const durable = [
  {
    ...
    body: "Your standard contract positions, your typical pushback language, your partners' house style, your conflict-check ritual — none of this is written down anywhere a wizard can read. It lives in your partners' heads, surfaces during discovery interviews, and gets codified into workflows by a human who knows what to ask for.",
    icon: (
  ...
  },
  {
    ...
    body: "ABA Model Rules and your state's professional conduct rules live in case law, comment threads, and ethics opinions — not API documentation. Mapping Rule 1.6 to a Claude tenant configuration that your malpractice carrier will sign off on is regulated services work. Anthropic will not (and cannot, for liability reasons) do this for your firm.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    body: "Most firms have at least one piece of software nobody else uses — a partner-built matter tracker from 2014, a custom intake form, a billing add-on, a deal-document repository that runs the practice. When the standard integrations don't reach it, we build a careful secure bridge ourselves — one-way where it should be one-way, locked down to your firm's network. Anthropic will never ship a connector for software only your firm uses.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    body: "Anthropic ships new practice tools monthly. State bars publish AI-specific opinions quarterly. Your firm's matter mix shifts year over year. New associates need workflows their predecessor relied on. The runbook is a living document; the retainer is how it stays that way without re-doing a sprint.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    body: "Should your firm sprint now, run a pilot, or wait six months? Should this workflow be customized for your trusts and estates group or your real estate group first? Is your malpractice carrier's AI clause going to bite next renewal? These are judgment calls that a wizard cannot make. They're what your partners are actually paying for.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    body: "Malpractice carriers updated their renewal questionnaires to include AI usage in 2025. Several Illinois carriers now require a written AI usage policy as a precondition of renewal. The policy that gets your firm renewed needs to be re-validated against the carrier's current questionnaire every year — and the questionnaires keep changing. That's recurring carrier-liaison work that doesn't show up in a product roadmap.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
