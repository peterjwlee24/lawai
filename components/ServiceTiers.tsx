...
const tiers = [
  {
    ...
    includes: [
      "A live, partner-led working call over video with a senior engineer",
      "A walkthrough of Claude for Legal inside a sample firm tenant",
      "Live demo of two or three practice-area tools against a workflow you pick",
      "A written Implementation Readiness Assessment delivered within two business days",
      "A short follow-up call to discuss the assessment",
  ...
  },
  {
    ...
    includes: [
      "A live discovery call to scope your highest-volume workflow",
      ...
      "Two secure connections to your existing software — pick from your document system, email, calendar, or billing",
      "One custom one-click workflow built around your firm's playbook",
      "A bar-compliant usage policy template for your jurisdiction",
      "One live training session covering attorneys and staff together",
      "A written runbook and a month of email support",
    ],
  ...
  },
  {
    ...
    includes: [
      "Live discovery covering your matter intake, contract review, and conflict-check workflows",
      "Three practice-area toolsets activated and tuned",
      "Four secure connections — document system, email, calendar, and your practice-management platform",
      "Two custom one-click workflows built around your firm's playbook",
      "A bar-compliant usage policy, lightly tailored to your firm",
      "Two live training sessions — one for attorneys, one for staff",
      "A written runbook, two months of email support, and a 30-day check-in",
    ],
  ...
  },
  {
    ...
    includes: [
      "Live discovery covering your full operational stack",
      "Up to five practice-area toolsets activated, tuned to your firm's playbook",
      "Up to eight secure connections covering document management, billing, calendar, email, research tools, and your practice-management system",
      "Microsoft 365 integration so Claude works inside Word and Outlook the way your team already does",
      "Up to five custom one-click workflows for your highest-volume tasks",
      "Custom-coded connections to bespoke firm software when a standard integration doesn't exist",
      "A bar-compliant usage policy fully customized to your firm's practice areas and your state's rules",
      "Your firm's templates, brief bank, and prior matters loaded for grounded answers",
      "Two live training sessions, a written runbook, ninety days of email support, and scheduled 30/60/90-day check-ins",
    ],
  ...
  },
  {
    ...
    includes: [
      "Extended live discovery covering each practice area separately",
      "Multi-practice-area customization — separate playbooks per group",
      "Up to twelve secure connections, including specialty platforms like Thomson Reuters CoCounsel, Everlaw, Ironclad, DocuSign, and Box",
      "Up to eight custom one-click workflows tailored per practice group",
      "Dedicated live training for each practice group",
      "A governance dashboard and monthly usage reports for the first 90 days",
      "Two named firm champions credentialed per practice group",
      "120 days of email support and quarterly check-ins for the first year",
    ],
        ...
        >
          ...
          <div className="relative grid md:grid-cols-4 gap-6">
            <div className="md:col-span-1">
              ...
              <h3 className="text-2xl font-semibold leading-tight">No consultants in your office. Working firm by Friday.</h3>
            </div>
